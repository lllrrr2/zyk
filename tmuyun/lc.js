/*
 ...
 变量：lcCookie='xxxx@12345678910#abcdefg '  多个账号用 @ 或者 换行 分割
  ...
  */
  async function credential_auth() {
   let url = {
     ...
     body: `client_id=17&password=${encodeURIComponent($.pwd)}&phone_number=${$.mobile}`,
     headers: {

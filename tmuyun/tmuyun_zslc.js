/*
 ...
 变量：zslcCookie='xxxx@12345678910#abcdefg '  多个账号用 @ 或者 换行 分割
 定时一天三次
 cron: 10 8,10,19 * * *
 */
 const $ = new Env('掌上鹿城')
 ...
 let cookiesArr = [],
   message = "",
   channelId = ["5d5361fb1b011b137b853d34", "5d536248b19850248f2cd1a0", "5d53646ab19850248f2cd1a5", "5d5363831b011b137b853d37","5d5362deb19850248f2cd1a1","5da4082d1b011b7c692ffdf9"]
 cookie = ($.isNode() ? process.env.zslcCookie : $.getdata("zslcCookie")) || ``
 ...
 !(async () => {
     ...
     for (let i = 0; i < cookiesArr.length; i++) {
       if (cookiesArr[i]) {
         ...
         console.log(`\n******开始【🐳掌上鹿城账号${$.index}】${$.nickName}|${$.mobile}*********\n`);
         await main()
       }
     }
     if ($.isNode() && message) {
  ...
  */
  async function credential_auth() {
   let url = {
     ...
     body: `client_id=43&password=${encodeURIComponent($.pwd)}&phone_number=${$.mobile}`,
     headers: {

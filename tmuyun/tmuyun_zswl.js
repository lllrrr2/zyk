 ...
 */
 ...
 let cookiesArr = [],
   message = "",
   channelId = ["5bd2bef6b1985042e7691870", "5bd3fe2eb1985042e769196d", "5bd3fee1b1985042e7691971", "5bd2bf31b1985042e7691872","5bd3fe2eb1985042e769196e"]
 cookie = ($.isNode() ? process.env.zswlCookie : $.getdata("zswlCookie")) || ``
 ...
 !(async () => {
     ...
     for (let i = 0; i < cookiesArr.length; i++) {
       if (cookiesArr[i]) {
         ...
         console.log(`\n******开始【🐳掌上温岭账号${$.index}】${$.nickName}|${$.mobile}*********\n`);
         await main()
       }
     }
     if ($.isNode() && message) {
  ...
  */
  async function credential_auth() {
   let url = {
     ...
     body: `client_id=29&password=${encodeURIComponent($.pwd)}&phone_number=${$.mobile}`,
     headers: {

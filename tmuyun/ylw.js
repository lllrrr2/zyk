 ...
 */
 ...
 let cookiesArr = [],
   message = "",
   channelId = ["62c53767373c550ecabd9d6a ", "6327c414ad61a4052a4a2a12", "62c537afde224a0ebdf0fe7c", "62c537bc373c550ecabd9d6c", "63318faafe3fc1537e56b6e2","62c537a1fe3fc1538430e59a"]
 cookie = ($.isNode() ? process.env.ylwCookie : $.getdata("ylwCookie")) || ``
 ...
 !(async () => {
     ...
     for (let i = 0; i < cookiesArr.length; i++) {
       if (cookiesArr[i]) {
         ...
         console.log(`\n******开始【🐳阅龙湾账号${$.index}】${$.nickName}|${$.mobile}*********\n`);
         await main()
       }
     }
     if ($.isNode() && message) {
  ...
  */
  async function credential_auth() {
   let url = {
     ...
     body: `client_id=10008&password=${encodeURIComponent($.pwd)}&phone_number=${$.mobile}`,
     headers: {
